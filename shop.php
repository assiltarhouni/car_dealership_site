...
if (isset($_POST['add_to_wishlist'])) {
    ...
    if (mysqli_num_rows($check_wishlist_numbers) > 0) {
        ...
        mysqli_query($conn, "INSERT INTO `wishlist` (user_id, cid, name, price, image) VALUES ('$user_id', '$car_id', '$car_name', '$car_price', '$car_image')") or die('query failed');
...
<section class="products">
   ...
   <div class="box-container">
      <?php
         $select_cars = mysqli_query($conn, "SELECT * FROM `cars`") or die('query failed');
